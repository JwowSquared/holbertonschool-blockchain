...
int destroy_state_manager(state_manager_t *);
...
int bi_logout(state_manager_t *, char *, char *);
int bi_exit(state_manager_t *, char *, char *);

/* Builtin Display Functions */
int bi_print(state_manager_t *, char *, char *);
int bi_pending(state_manager_t *, char *, char *);
int bi_wallet(state_manager_t *, char *, char *);
